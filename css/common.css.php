...
html, body, div#pma_navigation_tree, div#pma_navigation_content, fieldset, table, div#page_content div#tableslistcontainer table.data, table tr:nth-child(odd), #pma_navigation_resizer, .ui-widget-content, .config-form fieldset p, .config-form ul.tabs li a {
...
#topmenu .tabactive, li.active, .config-form ul.tabs li.active a {
...
a.hover_show_full:hover, li:hover, li.no_bullets:hover, select, input, div.CodeMirror, #pma_console .toolbar.collapsed:not(:hover), #pma_console .toolbar, #pma_console .content {
...
div.CodeMirror-gutters, div.CodeMirror-linenumbers {
...
input[type='checkbox'], input.criteria_col {
    color: #444 !important;
